...
exp <- readRDS("results/expression/tcga_gbm_expression.rds")
...
write.table(
  pca$x,
  "results/pca/pca_coordinates.tsv",
  sep = "\t",
  quote = FALSE
)

png(
  "figures/pca_gbm_expression.png",
  width = 1000,
  height = 800
)
...
plot(
  ...
  xlab = "PC1",
  ylab = "PC2",
  main = "PCA of TCGA-GBM RNA-seq expression"
)
